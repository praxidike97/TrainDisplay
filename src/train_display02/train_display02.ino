...
//SDI=11  SCL=13  /CS =6  /RST=5  D/C=7
UTFT myGLCD(ST7735S_4L_80160,11,13,6,5,7);    //LCD:  4Line  serial interface      SDI  SCL  /CS  /RST  D/C    NOTE:Only support  DUE   MEGA  UNO
...
// Setup the LCD
  ...
  myFiles.load(0, 0, 240, 240, "image01.bmp", 1);
